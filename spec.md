...
- **SC-001**: Desde que abre la app, el usuario obtiene una recomendación en **2 toques** (elegir género, sortear) y en menos de 5 segundos.
- **SC-002**: El 100% de los animes sorteados pertenece al género seleccionado.
- **SC-003**: En 10 sorteos consecutivos sobre un género con dos o más animes, ninguno repite el título inmediatamente anterior.
- **SC-004**: El 100% de las pantallas que leen datos muestran un indicador de carga visible mientras dura la demora simulada.
- **SC-005**: Los estados vacío y de error de cualquier pantalla pueden demostrarse en menos de 2 minutos y sin modificar los datos.
- **SC-006**: Con los cinco campos del formulario inválidos a la vez, se muestran los errores de los 5 campos en un solo intento de guardado.
- **SC-007**: El 100% de los items guardados sigue presente tras cerrar por completo la app y volver a abrirla.
- **SC-008**: Ningún título puede quedar duplicado en Mi Lista.
- **SC-009**: Con el dispositivo sin conexión, el sorteo, el catálogo, el detalle y Mi Lista siguen funcionando.
- **SC-010**: Cualquiera de los dos integrantes puede verificar manualmente todos los criterios de una historia en menos de 2 minutos por historia.
